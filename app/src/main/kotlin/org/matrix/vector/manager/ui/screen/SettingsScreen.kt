                    ...
                    item {
                        ...
                        Card {
                            ArrowPreference(
                                ...
                                onClick = {
                                    try {
                                        if (org.matrix.vector.manager.util.ShortcutUtil.isRequestPinShortcutSupported(context)) {
                                            val success = org.matrix.vector.manager.util.ShortcutUtil.requestPinLaunchShortcut {
